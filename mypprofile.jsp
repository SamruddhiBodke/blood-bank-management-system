...
Statement Stm=conn.createStatement();
                String sql="select p_id,patient.pname,patient.address,city,pincode,email,phone,age,gender,patient.username,patient.password from patient,profile where patient.password=profile.password";
